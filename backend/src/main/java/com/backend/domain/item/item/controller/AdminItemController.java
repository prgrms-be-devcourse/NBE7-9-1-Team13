...
public class AdminItemController {
    ...
    public RsData<List<ItemResponse>> getAllItems() {
        ...
        return RsData.success("상품 전체 조회 성공", items);
    }
    ...
    public RsData<ItemResponse> getItemById(@PathVariable Long id) {
        ...
        return RsData.success("%d번 상품 조회 성공".formatted(id), item);
    }
    ...
    public RsData<ItemResponse> createItem(
        ...
        return RsData.success("상품 생성 성공", created);
    }
    ...
    public RsData<Void> updateItem(
        ...
        return RsData.success( "%d번 상품 수정 성공".formatted(id));
    }
    ...
    public RsData<Void> deleteItem(@PathVariable Long id){
        ...
        return RsData.success("%d번 상품 삭제 성공".formatted(id));
    }
}
